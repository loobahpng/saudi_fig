...
ax2.plot(VarExp*0,'--r')
ax1.set_xlim([0,1800])
ax1.set_xlim([1800,3600])
ax1.set_xlim([121,240])
...
fontsize=18
leg1=ax1.legend(["CTR"],loc='upper left',fontsize=fontsize)
leg2=ax2.legend(["IRR-CTR"],loc='upper right',fontsize=fontsize)
